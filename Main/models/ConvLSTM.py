...
class ConvLSTM(nn.Module):
    ...
    def forward(self, inputs):
        print(inputs.shape)
        input()
        it = self._sigmoid(self._Wxi(inputs)+self._Whi(self._H)+self._Wci(self._C)+self._bi)
        print(it.shape)
        input()
        ft = self._sigmoid(self._Wxf(inputs)+self._Whf(self._H)+self._Wcf(self._C)+self._bf)
        print(ft.shape)
        input()
        Ct = ft * self._C + it *self._tanh(self._Wxc(inputs)+self._Whc(self._H)+self._bc)
        print(Ct.shape)
        input()
        ot = self._sigmoid(self._Wxo(inputs)+self._Who(self._H)+self._Wco(self._C)+self._bo)
        print(ot.shape)
        input()
